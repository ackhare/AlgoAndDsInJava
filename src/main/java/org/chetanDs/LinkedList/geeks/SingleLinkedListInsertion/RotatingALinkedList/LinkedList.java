package org.chetanDs.LinkedList.geeks.SingleLinkedListInsertion.RotatingALinkedList;
/*
...
Store pointer to kth node. We can get (k+1)th node using kthNode->next.
 Keep traversing till end and store pointer to last node also. Finally,
 change pointers as stated above.
 */
